 ...
 *
 * Navigation arrives as [onNavigateBack] rather than a NavController, so the screen has no opinion
 * about where it sits in the graph and previews without one.
 */
